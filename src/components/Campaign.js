    ...
    <div className="container-fluid">
      <section className="campaign-header">
        <div className="container">
          <h2 className="campaign-header-title">Why you can trust us</h2>
          ...
          <div className="campaign-cards">
            <div className="campaign-card">
              <p className="campaign-card-icon">
                <i className="fa-solid fa-medal"></i>
              </p>
              <div className="campaign-card-details">
                <h3 className="campaign-card-title">Mission</h3>
            ...
            <div className="campaign-card">
              ...
              <div className="campaign-card-details">
                <h3 className="campaign-card-title">Support</h3>
                <p className="campaign-card-text">
                  Accusantium quam, ultricies eget tempor id, aliquam eget nibh
                  et. Maecen aliquam, risus at semper ullamcorper, magna
                </p>
            ...
            <div className="campaign-card">
              ...
              <div className="campaign-card-details">
                <h3 className="campaign-card-title">Volunteer</h3>
                <p className="campaign-card-text">
                  Accusantium quam, ultricies eget tempor id, aliquam eget nibh
                  et. Maecen aliquam, risus at semper ullamcorper, magna
                </p>
            ...
            <div className="campaign-card">
              ...
              <div className="campaign-card-details">
                <h3 className="campaign-card-title">Events</h3>
                <p className="campaign-card-text">
                  Accusantium quam, ultricies eget tempor id, aliquam eget nibh
                  et. Maecen aliquam, risus at semper ullamcorper, magna
                </p>
            ...
            <div className="campaign-card">
              ...
              <div className="campaign-card-details">
                <h3 className="campaign-card-title">Donations</h3>
                <p className="campaign-card-text">
                  Accusantium quam, ultricies eget tempor id, aliquam eget nibh
                  et. Maecen aliquam, risus at semper ullamcorper, magna
                </p>
            ...
            <div className="campaign-card">
              ...
              <div className="campaign-card-details">
                <h3 className="campaign-card-title">Solutions</h3>
                <p className="campaign-card-text">
                  Accusantium quam, ultricies eget tempor id, aliquam eget nibh
                  et. Maecen aliquam, risus at semper ullamcorper, magna
                </p>
      ...
      <section className="section-cause">
        <div className="container">
          <h2 className="cause-title section-cause-title">
            Choose your cause and donate
          </h2>
          <div className="cause-cards">
            ...
            <div className="cause-card">
              <img src={failure} alt="Facing a failure" className="cause-img" />
              <h2 className="cause-header">Sponsor an orphan child</h2>
              <p className="cause-text">
                Volunteering is generally considered an altruistic activity and
                is intended to promote goodness or improve human quality of
                life.
            ...
            <div className="cause-card">
              <img
                ...
                className="cause-img"
              />
              <h2 className="cause-header">Jobs for disabled people</h2>
              <p className="cause-text">
                Volunteering is generally considered an altruistic activity and
                is intended to promote goodness or improve human quality of
                life.
            ...
            <div className="cause-card">
              <img
                ...
                className="cause-img"
              />
              <h2 className="cause-header">Support military families</h2>
              <p className="cause-text">
                Volunteering is generally considered an altruistic activity and
                is intended to promote goodness or improve human quality of
                life.
            ...
            <div className="cause-card">
              <img src={homeless} alt="Homeless child" className="cause-img" />
              <h2 className="cause-header">Family support program</h2>
              <p className="cause-text">
                Volunteering is generally considered an altruistic activity and
                is intended to promote goodness or improve human quality of
                life.
      ...
      <div className="container">
        <h2 className="sponsor-title-1">Featured campaign</h2>
        <div className="sponsor-child">
          ...
          <div className="sponsor-content">
            <h2 className="sponsor-title">Support military families</h2>
      ...
      <section className="donators">
        <div className="container">
          <div className="donator">
            <h2 className="donator-heading">Latest Donators</h2>
